...
import filter.AutenticacaoJwtFilter;
...
public class AuthConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		return http.csrf(csrf -> csrf.disable()).cors(cors -> Customizer.withDefaults())
				.authorizeHttpRequests(
						req -> req.requestMatchers(AntPathRequestMatcher.antMatcher("/auth/**")).permitAll())
